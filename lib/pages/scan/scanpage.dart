...
import 'package:med_reminder/pages/scan/CapturePictureScreen.dart';
  ...
  Future<void> _recognizeText() async {
    ...
    try {
      ...
      sortedBlocks.sort((a, b) {
        ...
        if (aTop != bTop) {
          return aTop
              .compareTo(bTop); // Sort by top-left y-coordinate (top to bottom)
        } else {
          return a.boundingBox!.left.compareTo(b.boundingBox!
              .left); // Sort by top-left x-coordinate (left to right)
        }
      });
          ...
          child: BottomAppBar(
              child: Column(
                ...
                ElevatedButton(
                  ...
                  child:
                      Text(_Loading ? 'Loading....' : 'Get Medicine Details'),
                ),
              ])),
        ));
  }
