...
import 'package:med_reminder/pages/time_settings.dart';
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => time_setting_page()));
            },
          ),
        ],
      ),
                    ...
                    child: ListTile(
                      onTap: () {
                        Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        edit_med_page(medicine: medicine)))
                            .then((value) => setState(() {}));
                      },
                      subtitle: Container(
                        padding: EdgeInsets.all(10),
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      '${medicine.name!.length <= 25 ? medicine.name : medicine.name?.substring(0, 25)}',
                                      style: TextStyle(
                                          fontSize: 20,
                                  ...
                                  Expanded(
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                          fontSize: 15,
                                          fontWeight: FontWeight
                                              .w400), // Normal style for medicine.time
                                    ),
                                  )
                                ],
                              ),
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () async {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => new_med_add()),
                ).then((value) {
